...
IPVPS=$(curl -sS https://raw.githubusercontent.com/daneshswara29/permission/main/ip | grep $MYIP | awk '{print $4}')
if [[ $MYIP == $IPVPS ]]; then
domain
Casper2
else
...
rm -rf /etc/github
mkdir /etc/github
curl -s https://pastebin.com/raw/r0dwDg8p > /etc/github/api
curl -s https://pastebin.com/raw/M3YpM7hV > /etc/github/email
curl -s https://pastebin.com/raw/fYvzeii8 > /etc/github/username
clear
...
mkdir /root/rmbl
cd /root/rmbl
wget https://raw.githubusercontent.com/daneshswara29/permission/main/ip >/dev/null 2>&1
...
LIST=$(curl -sS https://raw.githubusercontent.com/daneshswara29/license/main/key | grep $kode | awk '{print $2}')
Key=$(curl -sS https://raw.githubusercontent.com/daneshswara29/license/main/key | grep $kode | awk '{print $3}')
KEY2=$(curl -sS https://raw.githubusercontent.com/daneshswara29/license/main/key | grep $kode | awk '{print $4}')
ADMIN=$(curl -sS https://raw.githubusercontent.com/daneshswara29/license/main/key | grep $kode | awk '{print $5}')
TOTALIP=$(curl -sS https://raw.githubusercontent.com/daneshswara29/license/main/key | grep $kode | awk '{print $6}')
cd
...
sleep 0.5
rm ip
wget https://raw.githubusercontent.com/daneshswara29/license/main/key >/dev/null 2>&1
if [ "$ADMIN" = "ON" ]; then
...
res1() {
wget --no-check-certificate https://raw.githubusercontent.com/daneshswara29/new/main/install/rmbl.sh && chmod +x rmbl.sh && ./rmbl.sh
clear
}
res2() {
wget https://raw.githubusercontent.com/RM/v1/main/install/r1.sh && chmod +x cr1.sh && ./per1.sh
clear
}
res3() {
wget https://raw.githubusercontent.com/RM/v1/main/install/c2.sh && chmod +x c2.sh && ./cr2.sh
clear
}
res4() {
wget https://raw.githubusercontent.com/RMN/v1/main/install/r3.sh && chmod +x r3.sh && ./r3.sh
clear
}
clear
cd
...
echo -e  "${LINECYAN}│                \033[1;37m Admin @D_swara                 ${LINECYAN}│${NC}"
echo -e  "${LINECYAN}╰══════════════════════════════════════════╯${NC}"
echo " "
...
echo -e "${LINECYAN}╰══════════════════════════════════════════╯${NC}"
echo -e "${LINECYAN}╭══════════════════════════════════════════╮${NC}"
echo -e "${LINECYAN}│  [ 1 ]  \033[1;37mDomain xxx.tokodswara.my.id          ${NC}"                                        
echo -e "${LINECYAN}╰══════════════════════════════════════════╯${NC}"
...
clear
echo -e  "${LINECYAN}╭══════════════════════════════════════════╮${NC}"
echo -e  "${LINECYAN}│  \033[1;37mContoh subdomain xxx.tokodswara.my.id        ${LINECYAN}│${NC}"
...
clear
wget --no-check-certificate https://raw.githubusercontent.com/daneshswara29/new/main/tools.sh &> /dev/null
chmod +x tools.sh 
bash tools.sh
clear
start=$(date +%s)
...
res2() {
wget --no-check-certificate https://raw.githubusercontent.com/daneshswara29/new/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
clear
} 

res3() {
wget --no-check-certificate https://raw.githubusercontent.com/daneshswara29/new/main/install/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
}

res4() {
wget --no-check-certificate https://raw.githubusercontent.com/daneshswara29/new/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
}

res5() {
wget --no-check-certificate https://raw.githubusercontent.com/daneshswara29/new/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
}

res6() {
wget --no-check-certificate https://raw.githubusercontent.com/daneshswara29/new/main/sshws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
clear
}

res7() {
wget --no-check-certificate https://raw.githubusercontent.com/daneshswara29/new/main/menu/update.sh && chmod +x update.sh && ./update.sh
clear
}

res8() {
wget --no-check-certificate https://raw.githubusercontent.com/daneshswara29/slowdns/main/installsl.sh && chmod +x installsl.sh && bash installsl.sh
clear
}

res9() {
wget --no-check-certificate https://raw.githubusercontent.com/daneshswara29/new/main/install/udp-custom.sh && chmod +x udp-custom.sh && bash udp-custom.sh
clear
}

res10() {
wget --no-check-certificate https://raw.githubusercontent.com/daneshswara29/new/main/noobzvpns.zip
unzip noobzvpns.zip
chmod +x noobzvpns/*
cd noobzvpns
bash install.sh
...
res11() {
wget https://raw.githubusercontent.com/daneshswara29/hm/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
rm -rf limit.sh
clear
}
...
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/daneshswara29/permission/main/ip | grep $MYIP | awk '{print $3}' )
d1=$(date -d "$IZIN" +%s)
d2=$(date -d "$today" +%s)
EXP=$(( (d1 - d2) / 86400 ))
...
"'&reply_markup={"inline_keyboard":[[{"text":"🔥ᴏʀᴅᴇʀ","url":"https://t.me/D_swara"},{"text":"🔥 CHANNEL","url":"https://t.me/vpnreseller29"}]]}'
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/daneshswara29/new/main/versi  )
